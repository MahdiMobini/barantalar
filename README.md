...
- برای محیط production، بهتر است مقادیر حساس مثل Secret Key و اطلاعات دیتابیس در متغیرهای محیطی نگهداری شوند.
- برای استفاده از SMS، سرویس Kavenegar باید تنظیم و فعال باشد.
- برای اتصال فرانت‌اند، آدرس پایه API معمولاً این است:
...
- اضافه شدن پنل کاربری برای مدیریت رزروهای شخصی
- پشتیبانی از چند تالار و چند سالن
- افزودن سیستم پرداخت آنلاین
- بهبود UI/UX فرانت‌اند
- اتصال به سرویس‌های پیام‌رسانی پیشرفته‌تر
...
این پروژه در حال حاضر مجوز مشخصی ندارد. در صورت نیاز می‌توانید برای آن یک لایسنس مناسب انتخاب کنید.
